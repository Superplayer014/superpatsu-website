...
<head>
    ...
    footer {
        ...
        color: #9E9E9E; /* Subtle gray text */
        text-align: center;
        padding: 10px;
        position: relative;
        bottom: 0;
        width: 100%;
        box-shadow: 0 -1px 10px rgba(0, 0, 0, 0.2); /* Soft shadow for footer */
    }
</style>
</head>
<body>
    ...
    <div class="content">
        ...
        <a class="back-button" href="admin_dashboard.php?client_id=<?= $client_id ?>">Back to Dashboard</a>
    </div>
